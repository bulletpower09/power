...
bot = telebot.TeleBot('7335001738:AAGTg9bQgaaSCijIhdXUxc2QaAX7hM75Vrk')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "✅ Usage :- /bgmi <target> <port> <time> @RZRDEVIL"  # Updated command syntax
    else:
        response = " GANDU APNI ID TO ADD KARVALE ."
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to Your Home, {user_name}! Feel Free to Explore.Dm: 
